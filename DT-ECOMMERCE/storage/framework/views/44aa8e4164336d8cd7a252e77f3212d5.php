                ...
                <div class="col-9">
                    <div class="row">
                        <?php $__currentLoopData = $processedCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="product-box border">
                                    <div class="image">
                                        ...
                                        <?php if(isset($item['images'])): ?>
                                            <img src="<?php echo e($item['images']); ?>" alt="<?php echo e($item['title']); ?>"
                                                class="img-fluid">
                                        <?php endif; ?>
                                        ...
                                        <div class="hidden-items">
                                            ...
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#shoppingCartModal"
                                                ...
                                                data-id="<?php echo e($item['sku']); ?>" data-name="<?php echo e($item['title']); ?>"
                                                data-price="<?php echo e($item['prices']); ?>" data-image="<?php echo e($item['images']); ?>"
                                    ...
                                    <div class="text">
                                        <?php if($item['vendorName'] == 'wheelpros'): ?>
                                            <h6>
                                                <a
                                                    href="<?php echo e(url('/wp-product-detail/' . $item['sku'])); ?>"><?php echo e($item['title']); ?></a>
                                            </h6>
                                        <?php endif; ?>
                                        <?php if($item['vendorName'] == 'roughcountry'): ?>
                                            <h6>
                                                <a
                                                    href="<?php echo e(url('/rc-product-detail/' . $item['sku'])); ?>"><?php echo e($item['title']); ?></a>
                                            </h6>
                                        <?php endif; ?>
                            ...
                            <!-- Product Modal -->
                            <div class="modal fade custom-modal-width" id="ProductDetail-<?php echo e($key); ?>"
                                            ...
                                            <div class="row">
                                                ...
                                                <div
                                                    ...
                                                    <span class="card-title my-3"
                                                        style="font-size: 28px;"><?php echo e($item['title']); ?></span>
                                                    ...
                                                    <button data-bs-toggle="modal" data-bs-target="#shoppingCartModal"
                                                        ...
                                                        data-image="<?php echo e($item['images']); ?>" data-vendor="Vendor Name"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hasnat Khan\Desktop\Diligenttek\liftnasium\resources\views/shop.blade.php ENDPATH**/ ?>