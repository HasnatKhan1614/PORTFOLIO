...
<div class="row mb-5">
  <div class="col-md-12 col-lg-12">
          ...
          <div class="card">
            <div class="card-body ">
              <div class="py-3">
                <form id="galleryForm" enctype="multipart/form-data" action="{{ route('gallery.store') }}" method="POST">
                  @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
...
<div class="row mb-5">
  ...
  <div class="col-md-4 col-lg-4 mb-3">
      <div class="card h-100">
          <img class="card-img-top" src="{{ asset('storage/'.$item->image1) }}" width="300px" height="250px" alt="Card image cap">
          <div class="card-body d-flex flex-column justify-content-center align-items-center">
              <div class="text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p><b>Drive: </b>{{ $item->drive }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Vehicle Details: </b>{{ $item->vehicle_details }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Rubbing: </b>{{ $item->rubbing }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Trimming: </b>{{ $item->trimming }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Spacers: </b>{{ $item->spacers }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Front Wheel Spacers: </b>{{ $item->front_wheel_spacers }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Rear Wheel Spacers: </b>{{ $item->rear_wheel_spacers }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Wheel Title: </b>{{ $item->wheel_title }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Front Wheel: </b>{{ $item->front_wheel }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Rear Wheel: </b>{{ $item->rear_wheel }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Offset Wheel: </b>{{ $item->offset_wheel }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Backspacing Wheel: </b>{{ $item->backspacing_wheel }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Tire Title: </b>{{ $item->tire_title }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Front Tire: </b>{{ $item->front_tire }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Rear Tire: </b>{{ $item->rear_tire }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Brand Suspension: </b>{{ $item->brand_suspension }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Suspension: </b>{{ $item->suspension }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Modification: </b>{{ $item->modification }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Wheel Diameter: </b>{{ $item->wheel_diameter }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Wheel Width: </b>{{ $item->wheel_width }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Tire Height: </b>{{ $item->tire_height }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Tire Width: </b>{{ $item->tire_width }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Wheel Offset: </b>{{ $item->wheel_offset }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Type of Stance: </b>{{ $item->type_of_stance }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Wheel Brand: </b>{{ $item->wheel_brand }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Wheel Model: </b>{{ $item->wheel_model }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Tire Brand: </b>{{ $item->tire_brand }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Tire Model: </b>{{ $item->tire_model }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><b>Additional Information: </b>{{ $item->additional_information }}</p>
                    </div>
                </div>
                <div class="row d-flex justify-content-center">
                    <div class="col-md-6">
                        <p><b>Created At: </b>{{ $item->created_at->format('d-M-Y') }}</p>
                    </div>
                </div>
