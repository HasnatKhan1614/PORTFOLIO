...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ env('ASSET_URL') }}/assets/css/style.css">
    <link rel="stylesheet" href="{{ env('ASSET_URL') }}/assets/css/custom.css">
    <link rel="stylesheet" href="{{ env('ASSET_URL') }}/assets/css/gallery.css">
  ...
  <body>
        ...
        <div class="row align-items-top">
          <div class="col-lg-2 mb-3 mb-lg-0 col-md-3 col-sm-4 col-4 mx-auto text-center">
            <div class="logo mx-auto">
              <a href="{{ url('/') }}">
                <img src="{{env('ASSET_URL')}}/assets/images/logo.png" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          <div class="col-lg-10">
            <div class="row mb-5 align-items-center">
              ...
              <div class="col-lg-5">
                <div class="d-flex flex-wrap justify-content-end w-100 gap-5 align-items-center">
                  ...
                  @if(!Auth::user())
                      <a href="{{url('/login')}}" class="my-btn">Login</a>
                  @endif
                  @if(!Auth::user())
                      <a href="{{url('/register')}}" class="my-btn black">sign up</a>
                  @endif
            ...
            <div class="row">
              <div class="col-lg-7 mb-4 mb-lg-0">
                ...
                <ul class="menu text-white fw-bold">
                  ...
                  <li>
                    <a href="{{url('/shop')}}" class="{{request()->segment(1) == 'shop' ? 'active' : ''}}">Shop</a>
                  </li>
                  <li>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="d-flex justify-content-center gap-2 mt-5">
              ...
              <a href="{{url('/checkout')}}" class="my-btn btn btn-primary">Checkout</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer>
      <div class="footer-top position-relative">
        ...
        {{-- <div class="container px-5 z-2 position-relative">
          <div class="row align-items-center pb-5">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
              <p class="sign-up font-monsteret">Sign up for newsletter & get <span class="text-theme">25% OFF</span> for first order </p>
            </div>
            <div class="col-lg-4 mb-4 mb-lg-0">
          ...
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <div class="logo mb-3">
                  <img src="{{env('ASSET_URL')}}/assets/images/logo.png" alt="Logo" class="img-fluid">
                </div>
                <div class="d-flex justify-content-center gap-2 align-items-center">
                  <a href="#">
                    <img src="{{env('ASSET_URL')}}/assets/images/Img.png" alt="" class="img-fluid">
                  </a>
                  <a href="#">
                    <img src="{{env('ASSET_URL')}}/assets/images/Img-1.png" alt="" class="img-fluid">
                  </a>
                  <a href="#">
                    <img src="{{env('ASSET_URL')}}/assets/images/Img-2.png" alt="" class="img-fluid">
                  </a>
                  <a href="#">
                    <img src="{{env('ASSET_URL')}}/assets/images/Img-3.png" alt="" class="img-fluid">
                  </a>
                  <a href="#">
                    <img src="{{env('ASSET_URL')}}/assets/images/Img-4.png" alt="" class="img-fluid">
                  </a>
                </div>
              </div>
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
