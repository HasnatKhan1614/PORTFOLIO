...
@section('content')
              ...
              <div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
                  ...
                  <ul>
                      ...
                      <li class="tab-content tab-content-3 typography">
                          <form action="{{ route('search') }}" method="POST" style="width: 100%;">
                              ...
                              <div class="row" style="justify-content: center;width: 100%;">
                                  ...
                                  {{-- <div class="col-lg-3">
                              <div class="input-group mb-3">
                                 <select class="form-select rounded-0" aria-label="Select Wheel Diameter" name="wheelDiameter" id="wheelDiameterSelect">
                                    <option selected="">Wheel Diameter</option>
                                    <option class="ymm-li" value="3x4.41,3x112">3x112mm (3x4.41")</option>
                                    <option class="ymm-li" value="4x101.6,4x4">4x4" (4x101.6mm)</option>
                                    <option class="ymm-li" value="4x4.25,4x108">4x4.25" (4x108mm)</option>
                                    <option class="ymm-li" value="4x4.5,4x114.3">4x4.5" (4x114.3mm)</option>
                                    <option class="ymm-li" value="4x98,4x3.86">4x98mm (4x3.86")</option>
                                    <option class="ymm-li" value="4x3.94,4x100">4x100mm (4x3.94")</option>
                                    <option class="ymm-li" value="4x4.33,4x110">4x110mm (4x4.33")</option>
                                    <option class="ymm-li" value="4x4.92,4x125">4x115mm (4x4.92")</option>
                                    ...
                                    <option class="ymm-li" value="5x101.6,5x4">5x4" (5x101.6mm)</option>
                                    <option class="ymm-li" value="5x4.25,5x108">5x4.25" (5x108mm)</option>
                                    <option class="ymm-li" value="5x4.5,5x114.3">5x4.5" (5x114.3mm)</option>
                                    <option class="ymm-li" value="5x5,5x127">5x5" (5x127mm)</option>
                                    <option class="ymm-li" value="5x5.5,5x139.7">5x5.5" (5x139.7mm)</option>
                                    <option class="ymm-li" value="5x6.3,5x160">5x160mm (5x6.3")</option>
                                    <option class="ymm-li" value="5x6.5,5x165.1">5x6.5" (5x165.1mm)</option>
                                    <option class="ymm-li" value="5x3.94,5x100">5x100mm (5x3.94")</option>
                                    <option class="ymm-li" value="5x4.13,5x105">5x105mm (5x4.13")</option>
                                    <option class="ymm-li" value="5x4.33,5x110">5x110mm (5x4.33")</option>
                                    <option class="ymm-li" value="5x4.41,5x112">5x112mm (5x4.41")</option>
                                    <option class="ymm-li" value="5x4.52,5x115">5x115mm (5x4.52")</option>
                                    <option class="ymm-li" value="5x4.75,5x120.65">5x4.75" (5x120.65mm)</option>
                                    <option class="ymm-li" value="5x4.72,5x120">5x120mm (5x4.72")</option>
                                    <option class="ymm-li" value="5x5.12,5x130">5x130mm (5x5.12")</option>
                                    <option class="ymm-li" value="5x5.3,5x135">5x135mm (5x5.3")</option>
                                    <option class="ymm-li" value="5x5.91,5x150">5x150mm (5x5.91")</option>
                                    ...
                                    <option class="ymm-li" value="5x8.07,5x205">5x205mm (5x8.07")</option>
                                    <option class="ymm-li" value="5x98,5x3.86">5x98mm (5x3.86")</option>
                                    <option class="ymm-li" value="6x4.5,6x114.3">6x4.5" (6x114.3mm)</option>
                                    <option class="ymm-li" value="6x5,6x127">6x5" (6x127mm)</option>
                                    <option class="ymm-li" value="6x5.5,6x139.7">6x5.5" (6x139.7mm)</option>
                                    <option class="ymm-li" value="6x4.52,6x115">6x115mm (6x4.52")</option>
                                    <option class="ymm-li" value="6x4.72,6x120">6x120mm (6x4.72")</option>
                                    <option class="ymm-li" value="6x5.12,6x130">6x130mm (6x5.12")</option>
                                    <option class="ymm-li" value="6x5.2,6x132">6x132mm (6x5.2")</option>
                                    <option class="ymm-li" value="6x5.3,6x135">6x135mm (6x5.3")</option>
                                    <option class="ymm-li" value="7x150,7x5.91">7x150mm (7x5.91")</option>
                                    <option class="ymm-li" value="8x6.5,8x165.1">8x6.5" (8x165.1mm)</option>
                                    <option class="ymm-li" value="8x6.69,8x170">8x170mm (8x6.69")</option>
                                    <option class="ymm-li" value="8x7.09,8x180">8x180mm (8x7.09")</option>
                                    <option class="ymm-li" value="8x7.87,8x200">8x200mm (8x7.87")</option>
                                    <option class="ymm-li" value="8x8.27,8x210">8x210mm (8x8.27")</option>
                                    <option class="ymm-li" value="10x225,10x8.85">10x225mm (10x8.85)</option>
                                    <option class="ymm-li" value="10x285.75,10x11.25">10x285.75mm (10x11.25)</option>
                                 </select>
                              </div>
                           </div> --}}
                              </div>
                      ...
                      <li class="tab-content tab-content-last typography">
                        <form action="{{ url('/gallery') }}" method="POST" style="width: 100%;">
                           @csrf
          ...
          <div class="col-lg-6 mb-4 mb-lg-0">
            <div class="feature-box">
              <form action="{{ route('search') }}" method="GET">
                <div class="image" style="background-image: url('{{env('ASSET_URL')}}/assets/images/features.jpg');">
                  <div class="text">
          ...
          <div class="col-lg-3 mb-4 mb-lg-0">
            <div class="feature-box">
              <form action="{{ route('search') }}" method="GET">
                  ...
                  <div class="image" style="background-image: url('{{env('ASSET_URL')}}/assets/images/features-1.jpg');">
                    <div class="text">
          ...
          <div class="col-lg-3 mb-4 mb-lg-0">
            <div class="feature-box">
              <form action="{{ route('search') }}" method="GET">
                ...
                <div class="image" style="background-image: url('{{env('ASSET_URL')}}/assets/images/features-3.jpg');">
                  <div class="text">
          ...
          <div class="col-lg-3 mb-4 mb-lg-0">
            <div class="feature-box">
              <form action="{{ route('search') }}" method="GET">
                ...
                <div class="image" style="background-image: url('{{env('ASSET_URL')}}/assets/images/features-4.jpg');">
                  <div class="text">
          ...
          <div class="col-lg-3 mb-4 mb-lg-0">
            <div class="feature-box">
              <form action="{{ route('search') }}" method="GET">
                ...
                <div class="image" style="background-image: url('{{env('ASSET_URL')}}/assets/images/features-5.jpg');">
                  <div class="text">
          ...
          <div class="col-lg-6 mb-4 mb-lg-0">
            <div class="feature-box">
              <form action="{{ route('search') }}" method="GET">
                ...
                <div class="image" style="background-image: url('{{env('ASSET_URL')}}/assets/images/features-6.jpg');">
                  <div class="text">
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto text-white text-center">
            ...
            <div class="w-100 text-start">
              <a href="{{url('/gallery')}}" class="my-btn text-start">See our gallery</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <img src="{{env('ASSET_URL')}}/assets/images/gallery.png" alt="" class="img-fluid">
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <img src="{{env('ASSET_URL')}}/assets/images/gallery-1.png" alt="" class="img-fluid">
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <img src="{{env('ASSET_URL')}}/assets/images/gallery-2.png" alt="" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
    <section class="new-arrival">
      <div class="container">
        ...
        <div class="row">
          @foreach($resultsCollection as $key => $item)
                ...
                <div class="product-box border">
                    <div class="image">
                        ...
                        @if(isset($item['images']) && count($item['images']) > 0)
                            ...
                            <img src="{{ $item['images'][0]['imageUrlOriginal'] }}" alt="{{ $item['title'] }}" class="img-fluid">
                        @else
                            <!-- Handle case where no images are available -->
                            <img src="{{ asset('assets/images/no-image.png') }}" alt="Placeholder Image" class="img-fluid">
                        @endif
                        {{-- <span>Sale !</span> --}}
                        <div class="hidden-items">
                            ...
                            <a href="#" 
                              ...
                              data-price="{{$item['prices']['msrp'][0]['currencyAmount']}}" 
                              data-image="{{ $item['images'][0]['imageUrlOriginal'] }}" 
                    ...
                    <div class="text">
                        ...
                        @if(isset($item['prices']['msrp'][0]['currencyAmount']))
                        <div class="price d-flex gap-2 justify-content-center align-items-center">
                            ...
                            {{-- @php
                                $realPrice = $item['prices']['msrp'][0]['currencyAmount'] * 1.1;
                            @endphp
                            <p class="cut-price">${{ $realPrice }}</p> --}}
                            <!-- Actual regular price -->
                            <p class="regular-price">${{ $item['prices']['msrp'][0]['currencyAmount'] }}</p>
                        </div>
                        @endif
                    </div>
                </div>
                  ...
                  <div class="modal-body">
                    <div class="row">
                      ...
                      <div class="col-md-8">
                          @if(isset($item['images']) && count($item['images']) > 0)
                              <!-- Assuming the first image is used -->
                              <img width="50%" src="{{ $item['images'][0]['imageUrlOriginal'] }}" alt="{{ $item['title'] }}" class="img-fluid">
                          @else
                              <!-- Handle case where no images are available -->
                              <img width="50%" src="{{ asset('assets/images/no-image.png') }}" alt="Placeholder Image" class="img-fluid">
                          @endif
                      </div>
                      <!-- Details Column -->
                      <div class="closest-input-quantity col-md-4 d-flex flex-column justify-content-center border-bottom">
                        ...
                        <p class="card-text my-3">
                          ...
                          <span class="price current-price">${{ $item['prices']['msrp'][0]['currencyAmount'] }}</span>
                        </p>
    ...
    <section class="about-us">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <img src="{{env('ASSET_URL')}}/assets/images/about.png" alt="" class="img-fluid w-100">
          </div>
          <div class="col-lg-6">
            <h4>ABOUT US</h4>
                ...
                <ul class="splide__list">
                  <div class="splide__slide px-lg-3 px-md-2 px-0">
                    <div class="company-box">
                      <img src="{{env('ASSET_URL')}}/assets/images/company (1).jpg" alt="" class="img-fluid">
                    </div>
                  </div>
                  <div class="splide__slide px-lg-3 px-md-2 px-0">
                    <div class="company-box">
                      <img src="{{env('ASSET_URL')}}/assets/images/company (1).png" alt="" class="img-fluid">
                    </div>
                  </div>
                  <div class="splide__slide px-lg-3 px-md-2 px-0">
                    <div class="company-box">
                      <img src="{{env('ASSET_URL')}}/assets/images/company (1).svg" alt="" class="img-fluid">
                    </div>
                  </div>
                  <div class="splide__slide px-lg-3 px-md-2 px-0">
                    <div class="company-box">
                      <img src="{{env('ASSET_URL')}}/assets/images/company (1).webp" alt="" class="img-fluid">
                    </div>
                  </div>
                  <div class="splide__slide px-lg-3 px-md-2 px-0">
                    <div class="company-box">
                      <img src="{{env('ASSET_URL')}}/assets/images/company (2).png" alt="" class="img-fluid">
                    </div>
                  </div>
                  <div class="splide__slide px-lg-3 px-md-2 px-0">
                    <div class="company-box">
                      <img src="{{env('ASSET_URL')}}/assets/images/company (2).svg" alt="" class="img-fluid">
                    </div>
                  </div>
                  <div class="splide__slide px-lg-3 px-md-2 px-0">
                    <div class="company-box">
                      <img src="{{env('ASSET_URL')}}/assets/images/company (3).png" alt="" class="img-fluid">
                    </div>
                  </div>
                </ul>
              </div>
                ...
                <ul class="splide__list">
                  <div class="splide__slide">
                    <div class="testimonial-box">
                      ...
                      <div class="d-flex mt-4 gap-3 align-items-center">
                        <div class="image">
                          <img src="{{env('ASSET_URL')}}/assets/images/client.png" alt="" class="img-fluid">
                        </div>
                        <div class="text">
                  ...
                  <div class="splide__slide">
                    <div class="testimonial-box">
                      ...
                      <div class="d-flex mt-4 gap-3 align-items-center">
                        <div class="image">
                          <img src="{{env('ASSET_URL')}}/assets/images/client-1.png" alt="" class="img-fluid">
                        </div>
                        <div class="text">
                  ...
                  <div class="splide__slide">
                    <div class="testimonial-box">
                      ...
                      <div class="d-flex mt-4 gap-3 align-items-center">
                        <div class="image">
                          <img src="{{env('ASSET_URL')}}/assets/images/client-2.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="text">
      ...
      <div class="container">
        ...
        <div class="row mb-5 pb-4">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="blog-box">
              <div class="image">
                <img src="{{env('ASSET_URL')}}/assets/images/blog-1.png" alt="" class="img-fluid">
              </div>
              <div class="text">
                <h6 class="mb-0">
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="blog-box">
              <div class="image">
                <img src="{{env('ASSET_URL')}}/assets/images/blog-2.png" alt="" class="img-fluid">
              </div>
              <div class="text">
                <h6 class="mb-0">
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="blog-box">
              <div class="image">
                <img src="{{env('ASSET_URL')}}/assets/images/blog-3.png" alt="" class="img-fluid">
              </div>
              <div class="text">
                <h6 class="mb-0">
        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="d-flex gap-4 align-items-start features-box">
              <div class="image">
                <img src="{{env('ASSET_URL')}}/assets/images/icon.png" alt="" style="width: 4rem;" class="img-fluid">
              </div>
              <div class="text pt-3">
          ...
          <div class="col-lg-3">
            <div class="d-flex gap-4 align-items-start features-box">
              <div class="image">
                <img src="{{env('ASSET_URL')}}/assets/images/Icon-1.png" alt="" style="width: 4rem;" class="img-fluid">
              </div>
              <div class="text pt-3">
          ...
          <div class="col-lg-3">
            <div class="d-flex gap-4 align-items-start features-box">
              <div class="image">
                <img src="{{env('ASSET_URL')}}/assets/images/Icon-2.png" alt="" style="width: 4rem;" class="img-fluid">
              </div>
              <div class="text pt-3">
          ...
          <div class="col-lg-3">
            <div class="d-flex gap-4 align-items-start features-box">
              <div class="image">
                <img src="{{env('ASSET_URL')}}/assets/images/Icon-3.png" alt="" style="width: 4rem;" class="img-fluid">
              </div>
              <div class="text pt-3">
