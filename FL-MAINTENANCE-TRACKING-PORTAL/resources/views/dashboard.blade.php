								...
								<div class="box pull-up">
									<div class="box-body">
										<div class="d-flex align-items-center justify-content-between ">
											<div>
												<p class="text-mute mb-0">Total Companies</p>
												<h3 class="text-dark mb-0 mt-1 fw-500">{{ $totalCompanies }}</h3>
											</div>
							...
							<div class="col-xl-3 col-md-6 col-12">
								<div class="box pull-up">
									<div class="box-body">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												<p class="text-mute mb-0">Total Buildings</p>
												<h3 class="text-dark mb-0 mt-1 fw-500">{{ $totalBuildings }}</h3>
											</div>
							...
							<div class="col-xl-3 col-md-6 col-12">
								<div class="box pull-up">
									<div class="box-body">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												<p class="text-mute mb-0">Total Maintenances</p>
												<h3 class="text-dark mb-0 mt-1 fw-500">{{ $totalMaintenances }}</h3>
											</div>
							...
							<div class="col-xl-3 col-md-6 col-12">
								<div class="box pull-up ">
									<div class="box-body">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												<p class="text-mute mb-0 ">Total Users</p>
												<h3 class="text-dark mb-0 mt-1 fw-500 ">{{ $totalUsers }}</h3>
											</div>
												...
												<div class="box pull-up mb-0">
													<div class="box-body">
														...
														<div class="text-center">
															<img src="{{env('ASSET_URL')}}/dashboard/images/dashboard/image-1.png">
														</div>
														<div class="d-flex align-items-center justify-content-between ">
											...
											<div class="col-xl-4 col-md-12 col-12">
												<div class="box pull-up mb-0">
													<div class="box-body">
														...
														<div class="text-center">
															<img src="{{env('ASSET_URL')}}/dashboard/images/dashboard/image-2.png">
														</div>
														<div class="d-flex align-items-center justify-content-between ">
															<p class="mb-0 text-primary"><i class="fa fa-hand-paper-o"></i> Manual</p>
											...
											<div class="col-xl-4 col-md-12 col-12">
												<div class="box pull-up mb-0">
													<div class="box-body">
														...
														<div class="text-center">
															<img src="{{env('ASSET_URL')}}/dashboard/images/dashboard/image-3.png">
														</div>
														<div class="d-flex align-items-center justify-content-between ">
															<p class="mb-0 text-primary"><i class="fa fa-hand-paper-o"></i> Manual</p>
