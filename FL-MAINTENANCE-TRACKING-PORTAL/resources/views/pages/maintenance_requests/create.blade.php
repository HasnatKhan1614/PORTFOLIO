            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form id="maintenanceForm" class="form-Form-element">
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    <label for="building_id" class="col-sm-2 form-label">Building</label>
                                    <div class="col-sm-10">
                                ...
                                @role('superadmin')
                                    <div class="form-group row">
                                        <label for="company_id" class="col-sm-2 form-label">Company</label>
                                        <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="urgency" class="col-sm-2 form-label">Urgency</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" id="status">
                                            ...
                                            <option value="first contact">First
                                                Contact</option>
                                ...
                                @role('superadmin|manager|admin')
                                    <div class="form-group row">
                                        <label for="accounting_status" class="col-sm-2 form-label">Accounting Status</label>
                                        <div class="col-sm-10">
...
@section('script')
    <script>
        $("#maintenanceForm").submit(function(e) {
            ...
            $.ajax({
                url: '/maintenance-requests/store',
                type: 'POST',
                data: {
                    title: $("#title").val(),
