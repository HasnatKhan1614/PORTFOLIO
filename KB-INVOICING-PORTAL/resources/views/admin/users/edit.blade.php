...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="editForm" method="POST" action="{{ route('admin.users.update', $user->id) }}">
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" value="{{ $user->description }}"
