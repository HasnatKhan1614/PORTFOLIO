    ...
    <div class="cs-container">
        <div class="cs-invoice cs-style1">
                ...
                <div class="cs-invoice_head cs-type1 cs-mb25">
                    <div class="cs-invoice_right cs-text_right">
                        <div class="cs-logo cs-mb5">
                            <img src="{{ env('ASSET_URL') . Storage::url($data['logo_image']) }}" alt="Logo"
                                style="max-width: 252px; max-height: auto;">
                        </div>
                    </div>
                    ...
                    <div class="cs-round_border">
                        <div class="cs-table_responsive">
                            <table>
                                <thead>
                                    <tr>
                                        <th class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">Description
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="cs-border_none">
                                        ...
                                        <td colspan="5"
                                            ...
                                            {{ $data['currency_symbol'] . '' . number_format($totalAmount, 0) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div style="text-align: center; margin-top: 50px;">
                <p>
                    PDF Generated on {{ \Carbon\Carbon::parse($data['date'])->format('l, F jS, Y') }}
                </p>
            </div>
        </div>
    </div>
