                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="mb-0">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link primary-hover-bg" href="{{ route('user.dashboard') }}"
                                aria-expanded="false">
...
<span class="hide-menu ps-1">Order</span>
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ route('user.orders.index') }}" class="sidebar-link">
...
<span class="hide-menu ps-1">Invoices</span>
                            </a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ route('user.invoices.index') }}" class="sidebar-link">
                                        <span class="sidebar-icon"></span>
                                        <span class="hide-menu">List</span>
                                    </a>
                                </li>
                ...
                <div>
                    ...
                    <nav class="sidebar-nav scroll-sidebar container-fluid">
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link has-arrow primary-hover-bg"
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link has-arrow primary-hover-bg" href="#"
                                    ...
                                    <iconify-icon icon="solar:atom-line-duotone"
                                        class="fs-6 aside-icon"></iconify-icon>
                                    <span class="hide-menu ps-1">Orders</span>
                                </a>
                                <ul aria-expanded="false" class="collapse first-level">
                                    <li class="sidebar-item">
                                        <a href="{{ route('user.orders.index') }}" class="sidebar-link">
                                                    ...
                                                    <div class="profile-dropdown position-relative" data-simplebar>
                                                        ...
                                                        <div class="py-6 px-7 mb-1">
                                                            <form action="{{ route('logout') }}" method="POST">
                                                                @csrf
                                                                <button type="submit"
                                                                    class="btn btn-primary w-100">Log Out</button>
                                                            </form>
                                                        </div>
