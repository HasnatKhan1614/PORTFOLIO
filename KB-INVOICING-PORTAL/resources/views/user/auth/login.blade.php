                ...
                <div class="auth-login-wrapper card mb-0 container position-relative z-1 h-100 max-h-770"
                    ...
                    <div class="card-body">
                        <a href="../dark/index.html" class="">
                            <img src="{{ env('ASSET_URL') }}/dashboard/assets/images/logos/logo-dark.svg"
                                class="light-logo" alt="Logo-Dark" />
                            <img src="{{ env('ASSET_URL') }}/dashboard/assets/images/logos/logo-light.svg"
                                class="dark-logo" alt="Logo-light" />
                        </a>
                        <div class="row align-items-center justify-content-around pt-6 pb-5">
                            <div class="col-lg-6 col-xl-5 d-none d-lg-block">
                                <div class="text-center text-lg-start">
                                    <img src="{{ env('ASSET_URL') }}/dashboard/assets/images/backgrounds/login-security.png"
                                        alt="" class="img-fluid" />
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-5">
                                <h2 class="mb-6 fs-8 fw-bolder">Welcome to User</h2>
                                <p class="text-dark fs-4 mb-7">Your User Dashboard</p>
                                ...
                                <form method="POST" action="{{ route('user.login') }}">
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <input name="email" :value="old('email')" required autofocus autocomplete="email"
                                            type="email" class="form-control py-6" id="exampleInputEmail1"
                                    ...
                                    <div class="mb-9">
                                        ...
                                        <input name="password"  type="password" class="form-control py-6"
                                    ...
                                    <button class="btn btn-primary w-100 mb-7 rounded-pill">Sign
                                        In</button>
