<template>
    ...
    <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
        ...
        <div>
            <Link :href="`/inventory`" class="btn btn-primary">Back</Link>
        </div>
    </div>
    <div class="row">
