...
<div class="row row-cols-1 ">
 ...
 <tbody>
      ...
      <tr style="background-color: #D3D3D3 !important; color: black !important; font-size: 10px !important">
 <td style="width :40%;">@if(!empty($receipt_details->sell_custom_field_1_value))
  ...
  <td class="text-center" style="width :20%;"></td>
   <td class="text-end" style="width :40%;">اسم المشروع </td>
...
<tbody>
    ...
    <tr style="background-color: #D3D3D3 !important; color: black !important; font-size: 12px !important">
<td class="border-start">Seller</td>
<td Style="border: 0;">
				</td>

<td class="text-center"Style="border: 0;" > تفاصيل البائع</td></td>
<!-- purchase information	-->

<td class="text-center border-end" Style="border: 0;">Buyer
</td>
<td Style="border: 0;">	</td>

<td class="text-end" Style="border: 0;">اتفاصيل المشتري</td>
</tr>
...
<div class="row row-cols-1" style="color: #000000 !important;">
	<div class="col-xs-12">
		<br/>
		@php
			$p_width = 45;
		...
		<table class="table table-bordered table-no-top-cell-border table-slim ">
			<thead  >
				<tr class="table-no-side-cell-border table-no-top-cell-border text-center">
						<td style="background-color: #D3D3D3 !important; color: black !important;width: 3% !important">#</td>
					<th class="text-center" width="{{$p_width}}%" style="background-color: #D3D3D3 !important; color: black !important; font-size: 12px !important">{{$receipt_details->table_product_label}}</th>
					<th class="text-center" width="15%" style="background-color: #D3D3D3 !important; color: black !important; font-size: 12px !important">{{$receipt_details->table_qty_label}}</th>
					<th class="text-center" width="15%" style="background-color: #D3D3D3 !important; color: black !important; font-size: 12px !important">{{$receipt_details->table_unit_price_label}}</th>
					@if(!empty($receipt_details->discounted_unit_price_label))
						<th class="text-center" width="10%" style="background-color: #D3D3D3 !important; color: black !important; font-size: 12px !important">{{$receipt_details->discounted_unit_price_label}}</th>
					@endif
					@if(!empty($receipt_details->item_discount_label))
						<th class="text-center" width="10%" style="background-color: #D3D3D3 !important; color: black !important; font-size: 12px !important">{{$receipt_details->item_discount_label}}</th>
					@endif
					<th class="text-center" width="15%" style="background-color: #D3D3D3 !important; color: black !important; font-size: 12px !important">{{$receipt_details->table_subtotal_label}}</th>
				</tr>
			</thead>
			<tbody>
...
<div class="row row-cols-2 " style="background-color: #D3D3D3 !important; color: black !important; font-size: 12px !important"  >
<div class="col  text-enter ">Total Amount
</div>
<div class="col  text-end">إجمالي المبالغ</div>
</div>
<div class="row row-cols-1 "><!-- sales invoice Total Details 	-->
 ...
 <tr>
 <td style="width :40%;">Recruitment Amount
                                   </td>
  <td class="text-center" style="width :20%;"> {{ $receipt_details->total_due }}</td>
   <td class="text-end" style="width :40%;">المبلغ الإجمامبلغ التوظيف لريال السعودي</td>
...
<div class="row row-col-5 "  style="background-color: #D3D3D3 !important; color: white !important; font-size: 10px !important">
<div class="col border-start" style="width :10%;">
Amount in Words
</div>
<div class="col border-end" style="width :40%;">
{{$receipt_details->total_in_words}}
</div>
<div class="col borde-end" style="width :10%;">
Addditional Note
</div>
