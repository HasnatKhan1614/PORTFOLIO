...
class ExpenseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('project::project.expenses.index')->with(compact('projects'));
    ...
    public function report(Request $request)
    {
        ...
        if ($request->ajax()) {
            $expenses = ProjectExpense::with('project') // Use relationship
                ->select('project_id', DB::raw('SUM(amount) as total_expense'))
                ->groupBy('project_id')
                ->get();
