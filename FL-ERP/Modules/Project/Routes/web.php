...
Route::middleware('web', 'authh', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('project')->group(function () {
    ...
    Route::resource('project-expense', 'Modules\Project\Http\Controllers\ExpenseController');

    Route::get('/project-expense-report', [Modules\Project\Http\Controllers\ExpenseController::class, 'report']);
