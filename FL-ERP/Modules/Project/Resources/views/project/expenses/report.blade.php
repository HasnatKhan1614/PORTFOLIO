...
@section('content')
    ...
    <section class="content">
        @component('components.widget', ['class' => 'box-primary', 'title' => __('project::lang.all_project_expense_report')])
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="project_expense_report_table">
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="2" style="text-align:right">@lang('project::lang.page_total')</th>
                            <th class="page-total"></th>
                        </tr>
                        <tr>
                            <th colspan="2" style="text-align:right">@lang('project::lang.total')</th>
