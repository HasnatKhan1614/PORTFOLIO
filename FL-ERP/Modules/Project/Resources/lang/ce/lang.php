...
return [
    ...
    'all_project_expenses' => '所有项目支出',
    'add_project_expenses' => '添加项目支出',
    'edit_project_expenses' => '编辑项目支出',
    'project_expenses' => '项目支出',
    'manage_expenses' => '管理您的支出',
    'add_expense' => '添加支出',
    'edit_expense' => '编辑支出',
    'name' => '名称',
    'amount' => '金额',
    ...
    'action' => '操作',
    'total_expense' => '总支出',
    'project_expense_report' => '项目支出报告',
    'all_project_expense_report' => '所有支出报告',
    'expense_created_success' => '支出创建成功',
    'expense_updated_success' => '支出更新成功',
    'expense_deleted_success' => '支出删除成功',
