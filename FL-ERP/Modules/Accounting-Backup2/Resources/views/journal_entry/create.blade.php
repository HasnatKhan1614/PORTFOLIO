...
@section('content')
    ...
    <section class="content">
        ...
        {!! Form::open([
            'url' => action([\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'store']),
            'method' => 'post',
            'id' => 'journal_add_form',
        ]) !!}
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('accounting_account_cost_center_id', $costCenters, null, ['class' => 'form-control credit']) !!}
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-striped hide-footer" id="journal_table">
                        <thead>
                            <tr>
                                ...
                                {{-- <th class="col-md-3">Account Center</th> --}}
                            </tr>
                        </thead>
                        <tbody id="tableBody">
                            @for ($i = 1; $i <= 10; $i++)
                                <tr>
                                    ...
                                    {{-- <td>
                                        {!! Form::select('accounting_account_cost_center_id[' . $i . ']', $costCenters, null, ['class' => 'form-control credit']) !!}
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" id="addRow"
                                        class="btn btn-primary pull-right btn-flat">@lang('accounting::lang.add_more_row')</button>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
