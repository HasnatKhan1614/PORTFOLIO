                    ...
                    @slot('tool')
                        <div class="box-tools">
                            <button type="button" class="btn btn-block btn-primary btn-modal" 
                                data-href="{{action([\Modules\Accounting\Http\Controllers\AccountingAccountCostCenterController::class, 'create'])}}" 
...
<script type="text/javascript">
    $(document).ready( function(){
        ...
        transfer_table = $('#transfer_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{action([\Modules\Accounting\Http\Controllers\AccountingAccountCostCenterController::class, 'index'])}}",
                data: function(d) {
                    // var start = '';
                    // var end = '';
