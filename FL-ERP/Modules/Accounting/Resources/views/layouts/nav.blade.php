        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li @if(request()->segment(2) == 'cost-center') class="active" @endif><a href="{{action([\Modules\Accounting\Http\Controllers\AccountingAccountCostCenterController::class, 'index'])}}">Cost Center</a></li>
                </ul>
