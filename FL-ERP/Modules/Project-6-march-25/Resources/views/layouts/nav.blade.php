        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                        ...
                        <li @if(request()->segment(2) == 'project-expense') class="active" @endif><a href="{{action([\Modules\Project\Http\Controllers\ExpenseController::class, 'index'])}}">@lang('project::lang.project_expenses')</a></li>
                        <li @if(request()->segment(2) == 'project-expense-report') class="active" @endif><a href="{{action([\Modules\Project\Http\Controllers\ExpenseController::class, 'report'])}}">Project Expenses Report</a></li>
