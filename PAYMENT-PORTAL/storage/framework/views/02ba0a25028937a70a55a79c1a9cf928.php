...
<body
    ...
    <div class="cs-container"
                    ...
                    <div class="cs-invoice_left" style="margin-top: 0;line-height: 1.5em;max-width: 55%;">
                        <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"
                            ...
                            <b class="cs-primary_color" style="font-weight: bold;color: #111111;">Invoice
                                No:</b> <?php echo e($payment->invoice_number); ?>
                        ...
                        <p class="cs-invoice_date cs-primary_color cs-m0"
                            ...
                            </b><?php echo e($payment->created_at->format('d-m-y')); ?>
                        ...
                        <p class="cs-invoice_date cs-primary_color cs-m0 ]"
                            ...
                            <b class="cs-primary_color" style="font-weight: bold;color: #111111;">Status:
                                ...
                                <?php echo e($payment->status); ?></span>
                        </p>
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="cs-width_3"
                                            ...
                                            <?php echo e($payment->package_name); ?></td>
                                        <td class="cs-width_4"
        ...
        <?php if($inv_status == 'unpaid'): ?>
            <div>
                <a href="<?php echo e(url('/proceed/' . $payment->invoice_number)); ?>" class="custom-button"
...
<?php /**PATH C:\Users\Hasnat Khan\Desktop\freelance\usman-dtek\mypayportal\resources\views/email-invoice.blade.php ENDPATH**/ ?>