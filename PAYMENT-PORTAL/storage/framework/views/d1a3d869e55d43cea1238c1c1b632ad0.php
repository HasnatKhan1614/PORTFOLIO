...
<head>
    <title>Invoice From <?php echo e($payment->brand->name); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(env('ASSET_URL')); ?>/invoice/assets/css/style.css">
    <style>
        .badge-unpaid {
...
<body>
    ...
    ?>
    <input type="hidden" value="<?php echo e($payment->invoice_number); ?>" id="invoiceNumber">

    <?php if($payment->gateway->type == 'paypal' && $payment->status !== 'paid'): ?>
        <div class="container">
            <div class="row">
                            ...
                            <div class="cs-invoice_in" id="download_section">
                                <div class="cs-invoice_head cs-type1 cs-mb25">
                                    ...
                                    <div class="cs-invoice_left">
                                        <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b
                                                ...
                                                No:</b> <?php echo e($payment->invoice_number); ?></p>
                                        <p class="cs-invoice_date cs-primary_color cs-m0"><b
                                                class="cs-primary_color">Date:
                                            </b><?php echo e($payment->created_at->format('d-m-y')); ?></p>
                                        <p class="cs-invoice_date cs-primary_color cs-m0 ]"><b
                                                class="cs-primary_color">Status:
                                            </b><span
                                                class="<?php echo e($inv_status == 'paid' ? 'badge-paid' : 'badge-unpaid'); ?>">
                                                <?php echo e($payment->status); ?></span></p>
                                    </div>
                                    <div class="cs-invoice_right cs-text_right">
                                        <?php if(!empty($payment->brand->logo_path)): ?>
                                            <div class="cs-logo cs-mb5">
                                                <img src="<?php echo e(asset('storage/' . $payment->brand->logo_path)); ?>"
                                                    alt="Logo">
                                            </div>
                                        <?php endif; ?>
                                ...
                                <div class="cs-invoice_head cs-mb10">
                                    <div class="cs-invoice_left">
                                        ...
                                        <p>Name: <?php echo e($payment->customer->first_name ?? 'N/A'); ?>

                                            <?php echo e($payment->customer->last_name ?? ''); ?><br>
                                            Email: <?php echo e($payment->customer->email ?? 'N/A'); ?><br>
                                            Phone Number: <?php echo e($payment->customer->phone_number ?? 'N/A'); ?><br>
                                        </p>
                                    </div>
                                    <div class="cs-invoice_right cs-text_right">
                                        <b class="cs-primary_color">Pay To:</b>
                                        <p>
                                            <?php echo e($payment->brand->name); ?> <br>
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div class="cs-round_border">
                                        <div class="cs-table_responsive">
                                            <table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="cs-width_3"><?php echo e($payment->package_name); ?></td>
                                                        <td class="cs-width_4"><?php echo e($payment->description); ?></td>
                                                ...
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr class="cs-border_left">
                                                            ...
                                                            <td
                                                                class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">
                                                                <?php echo e($payment->remaining); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="cs-container">
                        ...
                        <script src="https://www.paypal.com/sdk/js?client-id=<?php echo e($payment->gateway->key1); ?>&currency=USD"></script>
                        <script>
                            var appUrl = "<?php echo e(env('APP_URL')); ?>";
                            $.ajaxSetup({
                                headers: {
                            ...
                            paypal.Buttons({
                                createOrder: function(data, actions) {
                                    return actions.order.create({
                                        purchase_units: [{
                                            amount: {
                                                value: <?php echo e($totalAmount); ?> // Replace with the actual amount
                                            }
                                        }],
                                        application_context: {
                                        ...
                                        payer: {
                                            name: {
                                                given_name: "<?php echo e($payment->customer->name); ?>",
                                                surname: "<?php echo e($payment->customer->name); ?>"
                                            },
                                            email_address: "<?php echo e($payment->customer->email); ?>",
                                            address: {
                                ...
                                onApprove: function(data, actions) {
                                    ...
                                    return actions.order.capture().then(function(details) {
                                        ...
                                        var invoice_number = "<?php echo e($payment->invoice_number); ?>";
                                        ...
                                        $.ajax({
                                            url: "<?php echo e(route('paypal.success')); ?>", // Replace with your server URL
                                            method: 'POST',
                                            data: {
    ...
    <?php else: ?>
        <div class="cs-container">
                    ...
                    <div class="cs-invoice_head cs-type1 cs-mb25">
                        ...
                        <div class="cs-invoice_left">
                            ...
                            <p class="cs-invoice_date cs-primary_color cs-m0 ]"><b class="cs-primary_color">Status:
                                </b><span class="<?php echo e($inv_status == 'paid' ? 'badge-paid' : 'badge-unpaid'); ?>">
                                    <?php echo e($payment->status); ?></span></p>
                        </div>
                        <div class="cs-invoice_right cs-text_right">
                            <?php if(!empty($payment->brand->logo_path)): ?>
            ...
            <?php if($inv_status == 'unpaid'): ?>
                <div>
                    <a href="<?php echo e(url('/pay/' . $payment->invoice_number)); ?>" class="custom-button">Proceed</a>
                </div>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    <script src="<?php echo e(env('ASSET_URL')); ?>/invoice/assets/js/jquery.min.js"></script>
    <script src="<?php echo e(env('ASSET_URL')); ?>/invoice/assets/js/jspdf.min.js"></script>
    <script src="<?php echo e(env('ASSET_URL')); ?>/invoice/assets/js/html2canvas.min.js"></script>
    <script src="<?php echo e(env('ASSET_URL')); ?>/invoice/assets/js/main.js"></script>
</body>

</html>
<?php /**PATH C:\Users\Hasnat Khan\Desktop\freelance\usman-dtek\mypayportal\resources\views/proceed.blade.php ENDPATH**/ ?>