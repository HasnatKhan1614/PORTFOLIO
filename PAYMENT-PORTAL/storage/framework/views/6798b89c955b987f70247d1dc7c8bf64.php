                            ...
                            <div
                                ...
                                <div class="d-flex justify-content-sm-end justify-content-center">
                                    <div class="switch align-self-center">
                                        <a href="<?php echo e(url('/brands/create')); ?>" class="btn"
                            ...
                            <table id="table" class="table table-hover" style="width:100%">
                                ...
                                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?php echo e(asset('storage/' . $brand->logo_path)); ?>" alt="Logo"
                                                style="border-style: none;border: 0;max-width: 30%;height: auto;vertical-align: middle;">
                                        </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hasnat Khan\Desktop\sideprojects\mypayportal\resources\views/brand/index.blade.php ENDPATH**/ ?>