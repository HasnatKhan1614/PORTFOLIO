        ...
        $('#submitBtn').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    Snackbar.show({
                        text: response.message || 'Payment Link created successfully.',
                        duration: 5000,
                    });
                ...
                error: function (xhr) {
                    ...
                    } else if (xhr.status === 202 && res.email_error) {
                        Snackbar.show({
                            text: res.message + ' Email error: ' + res.email_error,
                            duration: 7000,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hasnat Khan\Desktop\freelance\usman-dtek\mypayportal\resources\views/payment/create.blade.php ENDPATH**/ ?>