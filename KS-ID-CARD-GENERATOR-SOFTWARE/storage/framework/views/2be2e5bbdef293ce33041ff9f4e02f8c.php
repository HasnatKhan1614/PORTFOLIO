                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mt-3">
                                <a href="<?php echo e(asset('files/sample_students.xlsx')); ?>" class="btn btn-secondary">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dataTable = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('students.index')); ?>",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
            ...
            $('#table').on('click', '.delete', function(event) {
                ...
                const url = "<?php echo e(route('students.destroy', ':id')); ?>".replace(':id', studentId);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hasnat Khan\Desktop\kreatixsolutions\id-card\resources\views/pages/students/index.blade.php ENDPATH**/ ?>