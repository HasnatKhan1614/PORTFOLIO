...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(env('ASSET_URL')); ?>/assets/dist/css/adminlte.min.css?v=3.2.0">

    <link rel="stylesheet" href="<?php echo e(env('ASSET_URL')); ?>/assets/plugins/select2/css/select2.min.css">
    <link rel="stylesheet"
        href="<?php echo e(env('ASSET_URL')); ?>/assets/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
...
<body class="hold-transition register-page">
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form method="POST" action="<?php echo e(route('user.registration')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <!-- Class Selection -->
                        ...
                        <!-- Placeholder for dynamic registration fields -->
                        <div id="dynamic-registration-fields2" class="col-12"></div>

                        <div class="col-12 mb-3">
                            <div class="form-group">
                                <!-- Message for already registered students -->
                                <div id="already-registered-message" style="display:none;" class="alert alert-warning">
    ...
    <script src="<?php echo e(env('ASSET_URL')); ?>/assets/dist/js/adminlte.min.js?v=3.2.0"></script>

    <!-- Include Select2 JS -->
    <script src="<?php echo e(env('ASSET_URL')); ?>/assets/plugins/select2/js/select2.full.min.js"></script>
    ...
    `;
        ...
        function loadStudents() {
            ...
            $('#class_id').on('change', function() {
                ...
                $.ajax({
                    url: '/get-students-by-class/' + classId + '/' +
...
<?php /**PATH C:\Users\Hasnat Khan\Desktop\kreatixsolutions\id-card\resources\views/registration.blade.php ENDPATH**/ ?>