    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ env('ASSET_URL') }}/assets/dist/img/AdminLTELogo.png" alt="SOFTWARE"
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('students.class.list') }}" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Registration
                                </p>
                        ...
                        {{-- <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('students.registration') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Registrations</p>
                                    </a>
                                </li>
