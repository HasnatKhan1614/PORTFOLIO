                        ...
                        <div class="card-body d-flex">
                            <div class="row">
                                <form class="selected-students-form" method="POST"
                                    action="{{ route('students.handleSelected') }}">
                                    @csrf
                                ...
                                <a href="{{ route('students.registration') }}" class="btn btn-secondary mx-2">All
                                    Registrations</a>
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dataTable = $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('students.registration') }}",
                    data: function(d) {
    ...
    <script>
        $(document).on('click', '.view', function() {
            ...
            const url = "{{ route('students.show', ':id') }}".replace(':id', studentId);
