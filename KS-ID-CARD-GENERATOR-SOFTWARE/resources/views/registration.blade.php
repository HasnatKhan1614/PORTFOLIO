...
<head>
    ...
    <link rel="stylesheet" href="{{ env('ASSET_URL') }}/assets/dist/css/adminlte.min.css?v=3.2.0">

    <link rel="stylesheet" href="{{ env('ASSET_URL') }}/assets/plugins/select2/css/select2.min.css">
    <link rel="stylesheet"
        href="{{ env('ASSET_URL') }}/assets/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
...
<body class="hold-transition register-page">
    <div class="register-box">
        ...
        <a href="{{ env('ASSET_URL') }}/assets/index2.html"><b>Student</b> Registration</a>
    </div> --}}
        <div class="card">
    ...
    <script src="{{ env('ASSET_URL') }}/assets/dist/js/adminlte.min.js?v=3.2.0"></script>

    <!-- Include Select2 JS -->
    <script src="{{ env('ASSET_URL') }}/assets/plugins/select2/js/select2.full.min.js"></script>
